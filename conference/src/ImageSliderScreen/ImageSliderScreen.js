        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={styles.container}>
                    ...
                    <Slideshow containerStyle={styles.view3style} overlay='true' captionStyle={{ fontSize: 17.2, Color: 'black',  textAlign: "center", alignSelf: 'center'}} titleStyle={{fontSize: 22, alignSelf: 'center', fontWeight: 'bold', marginVertical: 20}} indicatorSelectedColor	= '#013f53'
