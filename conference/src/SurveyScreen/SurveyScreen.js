                    ...
                    <ImageBackground style={styles.backImageBox} source={require('../../Images/drawable-xhdpi/backwithlogo.png' || '../../Images/drawable-xxhdpi/backwithlogo.png' || '../../Images/drawable-xxxhdpi/backwithlogo.png' || '../../Images/drawable-hdpi/backwithlogo.png' || '../../Images/drawable-mdpi/backwithlogo.png')}>
                        <View style={styles.innercontainer}>
                            <View style={styles.boardView}>
                                <ImageBackground style={styles.boardImage} source={require('../../Images/drawable-xhdpi/questionboard.png' || '../../Images/drawable-xxhdpi/questionboard.png' || '../../Images/drawable-xxxhdpi/questionboard.png' || '../../Images/drawable-hdpi/questionboard.png' || '../../Images/drawable-mdpi/questionboard.png')}>
